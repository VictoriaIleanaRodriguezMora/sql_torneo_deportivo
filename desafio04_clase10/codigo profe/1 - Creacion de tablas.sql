...
CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.jugador (
    ...
    INDEX dni_j (dni_j),
    CONSTRAINT fk_id_club FOREIGN KEY (id_jugador) REFERENCES club (id_club)
);

CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.equipo (
	...
	CONSTRAINT fk_id_equipo FOREIGN KEY (id_equipo) REFERENCES club (id_club)
...
CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.categoria (
    ...
    CONSTRAINT fk_categoria FOREIGN KEY (categoria) REFERENCES equipo (categoria)
);

CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.partido (
...
CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.goleador (
    ...
    INDEX cantidad_partidos_jugados (cantidad_partidos_jugados)
...
CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.condicion_alimentaria (
    ...
    omnivoro TINYINT NOT NULL,
    diabetico TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.talle (
	...
	tipo_de_talle TEXT(25) NOT NULL,
    id_por_tamaño TEXT(25) NOT NULL,
...
CREATE TABLE IF NOT EXISTS TorneoDeportivoVictoriaRodriguez.torneo (
	id_torneo	INT	NOT NULL  AUTO_INCREMENT,
	id_reglamento INT NOT NULL,
	partidos_a_jugar	INT  NOT NULL,
    partidos_jugados	INT	NOT NULL,
	nombre_torneo	VARCHAR(30)	NOT NULL,
	nombre_empresa	TEXT(60)	NOT NULL,
	ganador	INT NOT NULL,
    PRIMARY KEY (id_torneo)
    -- indice partidos a jugar para hacer calculos rapidos de las proximas fechas
);
